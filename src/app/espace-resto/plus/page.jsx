...
export default function RestaurantMore() {
  ...
  const links = [["Statistiques", "Chiffre d'affaires, panier moyen, meilleurs plats", BarChart3, "/espace-resto"], ["Publications", "Historique et portée de vos publicités", Megaphone, "/espace-resto/publier"], ["Profil boutique", "Bannière, horaires, avis et WhatsApp", Store, "/espace-resto/profil"], ["Abonnement", "Plan actuel et changement de formule", CreditCard, "/espace-resto"], ["Paramètres", "Informations du compte et boutique", Settings, "/espace-resto/profil"]];
